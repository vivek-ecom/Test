...
MyAccountDisplay={
	...
	prepareSubmit:function(form,logonPassword,logonPasswordVerify){
		...
		return true;
		//form.submit(); // comment out for static pages
	},
    ...
    */
	...
	showPopup:function(action,subscriptionId,message){
		...
		if (popup !=null) {			
			...
			popup.show();
			document.getElementById("Cancel_yes_"+action).href="javascript:MyAccountDisplay.cancelRecurringOrder("+subscriptionId+");dijit.byId('Cancel_"+action+"_popup').hide();";
